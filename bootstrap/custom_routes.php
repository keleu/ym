...
route::group(array('middleware' => ['topc_middleware_redirectIfFromWap', 'theme_middleware_preview']), function() {
    ...
    */
    route::group(array(), function() {
        ...
        */
        ...
        route::get('loginurl.html', ['uses' => 'yytapi_ctl_loginurl_login@callBack' ]);
    ...
    */
    route::group(array('middleware' => 'topc_middleware_authenticate'), function() {
        ...
        route::get('trade-aftersales-shopZiti.html', [ 'uses' => 'topc_ctl_member_aftersales@ajaxZiti' ]);
        route::post('trade-aftersales-sendZiti.html', [ 'uses' => 'topc_ctl_member_aftersales@sendZiti' ]);
    ...
    */
    route::group(array('middleware' => 'topc_middleware_authenticate'), function() {
        ...
        route::get('cart-test.html', [ 'uses' => 'topc_ctl_cart@test' ]); #统计总金额
        route::post('cart-show.html', [ 'uses' => 'topc_ctl_cart@showCart' ]); #判断购物车中是否有该商品
        route::post('cart-ismobile.html', [ 'uses' => 'topc_ctl_cart@isMobile' ]); #判断是否绑定手机
        ...
        //2016-5-6 by jianghui 添加查看地图
        route::get('trade-consultMap.html', [ 'uses' => 'topc_ctl_cart@consultMap' ]);
    });
...
route::group(array('prefix' => 'wap', 'middleware' => 'theme_middleware_preview'), function() {
    ...
    */
    route::group(array(), function() {
        ...
        route::get('trade-consultMap.html', [ 'uses' => 'topm_ctl_cart@consultMap' ]);
    ...
    */
    route::group(array(), function() {
        ...
        route::get('catlistinfo.html', [ 'uses' => 'topm_ctl_category@catList' ]);
        #一级下面类目页
        route::get('topics-{cat_id}.html', [ 'uses' => 'topm_ctl_topics@index' ]);
        ...
        route::post('item-collectno.html', [ 'uses' => 'topm_ctl_collect@ajaxFavNomess' ]);#收藏
        ...
        route::post('member-collectdelno.html', [ 'uses' => 'topm_ctl_collect@ajaxFavDelNomess' ]);
        # 商品列表
    ...
    */
    route::group(array('middleware' => 'topm_middleware_authenticate'), function() {
        ...
        #会员中心二维码
        route::get('member-qrcode.html', [ 'uses' => 'topm_ctl_member@getUserQrcode' ]);
        #会员中心付款码
        route::get('member-paymentQrcode.html', [ 'uses' => 'topm_ctl_member@paymentQrcode' ]);
        route::post('member-ajaxPayQrcode.html', [ 'uses' => 'topm_ctl_member@ajaxPayQrcode' ]);
        # 会员中心优惠券列表
        ...
        //2016-5-9 by jianghui 添加回寄内容
        route::post('member-aftersales-getBack.html', [ 'uses' => 'topm_ctl_member_aftersales@ajaxGetBack' ]);
        route::post('member-aftersales-sendziti.html', [ 'uses' => 'topm_ctl_member_aftersales@sendziti' ]);
    ...
    */
    route::group(array(), function() {
        ...
        route::post('cart-ismobile.html', [ 'uses' => 'topm_ctl_cart@isMobile' ]);#判断是否绑定手机
...
route::group(array('prefix' => 'shop','middleware' => 'topshop_middleware_permission'), function() {
    ...
    # 获取销售属性选择信息 处理混合价
    route::post('spec/selectpropsblend.html', [ 'as' => 'toputil.syscat.spec.selectpropsblend', 'uses' => 'topshop_ctl_sku@set_spec_index_blend' ]);
    # 商家后台报表
    ...
    #自提
    route::post('ziti/zititrade.html', [ 'as' => 'topshop.ziti.zititrade', 'uses' => 'topshop_ctl_shop_ziti@ajaxTrade' ]);
...
route::group(array('prefix' => 'utils'), function() {
    ...
    #推荐商品
    route::post('shop/recommendSearch.html', [ 'as' => 'topshop.shop.recommendSearch', 'uses' => 'topshop_ctl_shop_recommend@searchItem' ]);
});
...
|--------------------------------------------------------------------------
 */
route::group(array('prefix' => 'yimengshop'), function() {
...
route::group(array('prefix' => 'weixin'), function() {
    # 系统分类
    route::match(array('GET', 'POST'), '/', array('as' => 'weixin', 'uses' => 'weixin_wechat@index'));
    route::match(array('GET', 'POST'), '/set', ['uses' => 'weixin_base@valid']);
    route::match(array('GET', 'POST'), '/init', ['uses' => 'weixin_wechat@init']);
    route::get('login.html', ['uses' => 'weixin_wechat@login']);
    route::get('registered.html', ['uses' => 'weixin_wechat@registered']);
    route::get('registered_auto.html', ['uses' => 'weixin_wechat@registered_auto']);
    route::get('point.html', ['uses' => 'weixin_wechat@point_list']);
    route::get('payQrcode.html', ['uses' => 'weixin_wechat@pay_qrcode']);
    route::get('myQrcode.html', ['uses' => 'weixin_wechat@my_qrcode']);
    route::get('mypoint.html', ['uses' => 'weixin_base@getPoint']);
});
...
route::group(array('prefix' => 'app'), function() {
    # 系统分类
    route::match(array('GET', 'POST'), '/', array('as' => 'app', 'uses' => 'yytapi_ctl_app_download@download'));
});

//app支付
route::group(array('prefix' => 'apppayaction.do'), function() {
    # 系统分类
    route::match(array('GET', 'POST'), '/alipay', ['uses' => 'ectools_payment_plugin_appalipay_server@callback']);
    route::match(array('GET', 'POST'), '/weixinpay', ['uses' => 'ectools_payment_plugin_appwxpay_server@callback']);
    route::match(array('GET', 'POST'), '/unionpay', ['uses' => 'ectools_payment_plugin_appunionpay_server@callback']);
});
