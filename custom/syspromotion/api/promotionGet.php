...
final class syspromotion_api_promotionGet {
    ...
    public function promotionGet($params)
    {
        ...
        //2016-3-25 by jianghui 查找活动详情
        if($params['has_detail'])
        {
            $type = $promotionBasic['promotion_type'];
            $promotionBasic['detail'] = app::get('syspromotion')->model($type)->getRow('*', array('fullminus_id'=>$promotionBasic['rel_promotion_id']) );
        }
