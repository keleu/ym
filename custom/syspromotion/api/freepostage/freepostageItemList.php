    ...
    public function freepostageItemList($params)
    {
        ...
        if($freepostageInfo['freepostage_status']=='agree')
        {
            ...
            {*/
                ...
                //2016-5-12 by jianghui 添加积分显示
                foreach ($freepostageItemList as $key => $value) {
                    $freepostageItemList[$key]['blend'] = kernel::single('sysitem_blendShow')->show($value['blend_integral'],$value['blend_price']);
                }
