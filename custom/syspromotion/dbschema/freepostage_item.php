...
return  array(
    'columns' => array(
        ...
        //2016-5-12 by jianghui 添加积分
        'integral' => array(
            'type' => 'number',
            'default' => 0,
            'label' => app::get('sysitem')->_('积分兑换'),
            'comment' => app::get('sysitem')->_('积分兑换'),
        ),
        'blend_price' => array(
            'type' => 'money',
            'label' => app::get('sysitem')->_('混合价'),
            'comment' => app::get('sysitem')->_('混合价的现金'),
        ),
        'blend_integral' => array(
            'type' => 'number',
            'label' => app::get('sysitem')->_('混合价'),
            'comment' => app::get('sysitem')->_('混合价的积分'),
        ),
        'promotion_tag' => array(
            'type' => 'string',
            'length' => 10,
