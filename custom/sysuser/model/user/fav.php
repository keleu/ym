...
class sysuser_mdl_user_fav extends dbeav_model{
    ...
    function addFav($userId=null,$object_type='goods',$goods_id=null)
    {
        ...
        if($row = $this->getList('gnotify_id',$filter))
            return false;
        $goodsData = app::get('sysitem')->model('item')->getList('cat_id,title,price,item_id,image_default_id,integral',array('item_id'=>$goods_id));
        ...
        $sdf = array(
           ...
           'goods_point'=>$goodsData[0]['integral'],
