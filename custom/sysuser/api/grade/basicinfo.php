...
class sysuser_api_grade_basicinfo{
    ...
    public function basicinfo($params)
    {
        ...
        //2016-3-25 by jianghui 判断用户id是否存在
        $account = pamAccount::getAccountId() ? pamAccount::getAccountId() : userAuth::id();
        $userData = $objMdlUser->getRow('grade_id,experience', array('user_id'=>$account));
