...
class topc_ctl_member_rate extends topc_ctl_member {
   ...
   /*
    ...
    public function createRate()
    {
        ...
        $tradeFiltr = array(
            'tid' => $tid,
            'fields' => 'tid,user_id,buyer_rate,shop_id,status,created_time,end_time,orders.oid,anony,orders.user_id,orders.price,orders.item_id,orders.sku_id,orders.title,orders.spec_nature_info,orders.pic_path,orders.aftersales_status,orders.integral,orders.num',
        );
    ...
    public function edit()
    {
        ...
        //2016-4-1 by jianghui 改为积分+现金显示
