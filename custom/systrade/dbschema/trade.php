...
return  array(
    'columns' => array(
        ...
        'payment' => array(
            ...
            'comment' => app::get('systrade')->_('实付金额,订单最终总金额'),
        ),
        'payment_integral' => array(
            ...
            'width' => '50',
            'order' => 14,
            'label' => app::get('systrade')->_('实付积分'),
            'comment' => app::get('systrade')->_('实付积分,订单最终总积分'),
        ),
        'total_fee' => array(
            'type' => 'money',
            'default' => '0',
        ...
        'total_integral' => array(
            ...
            'default' => '0',
            'label' => '商品总积分',
            'comment' => app::get('systrade')->_('各子订单中商品integral * num的和，不包括任何优惠信息'),
        ),
        'post_fee' => array(
            'type' => 'money',
        ...
        'payed_integral' => array (
            'type' => 'number',
            'default' => '0',
            'editable' => false,
            'comment' => app::get('systrade')->_('已支付积分'),
        ),
        'seller_rate' => array(
            'type' => 'bool',
            /*
        ...
        'is_offline' => array(
            ...
            'required' => true,
            'editable' => false,
            'comment' => app::get('systrade')->_('是否线下订单'),
        ),
        'ziti_memo' => array(
            'type' => 'string',
            'length' => 300,
        ...
        'is_mendian' => array(
            ...
            'required' => true,
            'editable' => false,
            'comment' => app::get('systrade')->_('是否门店订单'),
