...
return  array(
    'columns'=>array(
        ...
        'integral' => array(
            'type' => 'number',
            'default' => '0',
            'comment' => app::get('systrade')->_('商品积分价'),
        ),
        'num' => array(
            'type' => 'number',
        ...
        'total_integral' => array(
            'type' => 'number',
            'default' => '0',
            'comment' => app::get('systrade')->_('应付积分'),
        ),
        'payment' => array(
            'type' => 'money',
            'default' => '0',
        ...
        'payment_integral' => array(
            'type' => 'number',
            'default' => '0',
            'comment' => app::get('systrade')->_('实付积分'),
        ),
        'discount_fee' => array(
            'type' => 'money',
            'default' => '0',
        ...
        'adjust_integral' => array(
            'type' => 'number',
            'default' => '0',
            'comment' => app::get('systrade')->_('手工调整积分'),
        ),
        'modified_time' => array(
            'type' => 'last_modify',
        ...
        'refund_integral' => array(
            'type' => 'number',
            'default' =>'0',
            'comment' => app::get('systrade')->_('退款积分'),
        ),
        'buyer_rate' => array(
            'type' => 'bool',
            /*
