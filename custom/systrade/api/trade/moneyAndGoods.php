...
class systrade_api_trade_moneyAndGoods{
    ...
    {
        //获取被操作的订单信息
        $params['fields'] = "user_id,tid,shop_id,status,payment,payment_integral,post_fee,pay_type,receiver_state,receiver_city,receiver_district,receiver_address,receiver_name,receiver_mobile,orders.tid,orders.oid,orders.item_id,orders.sku_id,orders.num,orders.sub_stock";
        ...
        try{
            $paymentParams = array(
                ...
                'integral' => $tradeInfo['payment_integral'],
            ...
            $tradeData['data']['payed_integral'] = $tradeInfo['payment_integral'];
