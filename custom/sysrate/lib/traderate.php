...
class sysrate_traderate {
    ...
    {
        $params['tid'] = $data['tid'];
        $params['fields'] = 'tid,shop_id,user_id,status,end_time,orders.title,orders.status,orders.spec_nature_info,orders.end_time,orders.price,orders.pic_path,orders.buyer_rate,orders.user_id,orders.aftersales_status,orders.shop_id,orders.oid,orders.anony,orders.item_id,orders.integral';
    ...
    public function __createItemRate($tid, $data, $tradeOrderData, $test=false)
    {
        ...
        $traderateInsert['item_integral'] = $tradeOrderData['integral'];//冗余积分价
