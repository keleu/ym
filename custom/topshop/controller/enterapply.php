...
class topshop_ctl_enterapply extends topshop_controller{
    ...
    private function __checkpost(&$postdata)
    {
        ...
        //2016-4-26 by jianghui 添加填写完整的地区
        ...
        $postdata['shop']['shop_area'] = $postdata['shop']['company_area_first'].$postdata['shop']['company_area_second'].$postdata['shop']['company_area_third'];
    }
