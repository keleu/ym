...
class topshop_ctl_promotion_freepostage extends topshop_controller {
    ...
    public function edit_freepostage()
    {
        ...
        if($apiData['freepostage_id'])
        {
            ...
            //2016-4-12 by jianghui 重新获取商品信息 解决不显示积分价和混合价
            $searchParams['fields'] = 'item_id,title,image_default_id,price,integral,blend_integral,blend_price';
            $searchParams['item_id'] = array_column($notEndItem,'item_id');
            $searchParams['item_id'] = join(',',$searchParams['item_id']);
        ...
        //2016-3-24 by jianghui 先隐藏起来 按积分免邮
        $pagedata['is_point']=1;
