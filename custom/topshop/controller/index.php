...
class topshop_ctl_index extends topshop_controller {
    ...
    public function getAverPrice($data)
    {
        ...
        else
        {
            ...
            $data['averIntegral'] = number_format($data['new_integral'] / $data['new_trade']);
        }
