...
class sysshop_ctl_admin_shop extends desktop_controller{
    ...
    public function addSelfShop()
    {
        ...
        foreach ($areaMap as $key => $value) {
            ...
            foreach ($value['children'] as $k => $v) {
                $temp =array();
                foreach ($v['children'] as $child => $ren) {
                    $temp[$ren['value']] = $ren;
                }
                $children[$v['value']]['children'] = $temp;
            }
    ...
    public function updateShopInfo($sellerId,$shopId)
    {
        ...
        $pagedata['shop']['company_area_first'] = $shopdata['shop']['company_area_first'];
        $pagedata['shop']['company_area_second'] = $shopdata['shop']['company_area_second'];
        $pagedata['shop']['company_area_third'] = $shopdata['shop']['company_area_third'];
    ...
    public function saveApply()
    {
        ...
        $post['shop']['shop_area'] = $shop['shop_area'];
    ...
    private function _getShop($data)
    {
        ...
        $shop['shop_area'] = $data['shop']['company_area_first'].$data['shop']['company_area_second'].$data['shop']['company_area_third'];
        $shop['shop_addr'] = $data['shop']['shop_addr'];
        $shop['company_area_first'] = $data['shop']['company_area_first'];
        $shop['company_area_second'] = $data['shop']['company_area_second'];
        $shop['company_area_third'] = $data['shop']['company_area_third']?$data['shop']['company_area_third']:'';
        return $shop;
    }
    ...
    private function __checkpost(&$postdata)
    {
        ...
        //2016-5-5 by jianghui 添加地区判断
        if($postdata['shop']['company_area_first']=='no' || $postdata['shop']['company_area_second']=='no' || $postdata['shop']['company_area_third']=='no'){
            $msg = app::get('sysshop')->_("请填写完整的所在地区");
