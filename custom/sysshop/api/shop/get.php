...
class sysshop_api_shop_get{
    ...
    public function get($params)
    {
        ...
        //2015-5-4 by jianghui 添加地区查询
        $row ="shop_id,shop_name,shop_descript,shop_type,status,open_time,qq,wangwang,shop_logo,shop_area,shop_addr,company_area_first,company_area_second,company_area_third";
        if($params['fields'])
        {
            $row = $params['fields'];
        }
