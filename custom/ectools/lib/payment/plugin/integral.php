 ...
 */
final class ectools_payment_plugin_integral extends ectools_payment_app implements ectools_interface_payment_app{
    /**
     * @var string 支付方式名称
     */
    public $name = '积分支付';
     ...
     * @var string 支付方式接口名称
     */
    public $app_name = '积分支付接口';
    /**
     * @var string 支付方式key
     */
    public $app_key = 'integral';
    /**
     * @var string 中心化统一的key
     */
    public $app_rpc_key = 'integral';
    /**
     * @var string 统一显示的名称
     */
    public $display_name = '积分支付';
    /**
     * @var string 货币名称
     */
    public $curname = 'CNY';
    ...
    public function __construct($app){
        ...
        $this->callback_url = "ectools_payment_plugin_alipay=>ectools_payment_plugin_integral";
        $this->submit_url = '';
    ...
    public function admin_intro(){
        return app::get('ectools')->_('积分支付后台自定义描述');
    }
    ...
    public function intro(){
        return app::get('ectools')->_('积分支付自定义描述');
    }
