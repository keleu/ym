...
class ectools_api_payment_createBill{
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'money_integral' => ['type'=>'number','valid'=>'required', 'description'=>'支付总积分', 'default'=>'', 'example'=>''],
    ...
    public function create($params)
    {
        ...
        $trades = app::get('ectools')->rpcCall('trade.get.list',array('tid'=>$params['tids'],'fields'=>'payment,user_id,shop_id,tid,status,payment_integral'));
        $count = $trades['count'];
        $trades = $trades['list'];
        ...
        try{
            ...
            foreach($trades as $value)
            {
                ...
                $payBill = array(
                    ...
                    'payment_integral' => $value['payment_integral'],
