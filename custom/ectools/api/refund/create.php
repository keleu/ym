...
class ectools_api_refund_create{
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'money_integral' => ['type'=>'json','valid'=>'required', 'description'=>'退款积分', 'default'=>'', 'example'=>''],
            'refund_bank' => ['type'=>'json', 'description'=>'退款银行', 'default'=>'', 'example'=>''],
            'refund_account' => ['type'=>'json', 'description'=>'退款账号', 'default'=>'', 'example'=>''],
            'refund_people' => ['type'=>'json','valid'=>'required', 'description'=>'退款操作人', 'default'=>'', 'example'=>''],
            'receive_bank' => ['type'=>'json', 'description'=>'收款银行', 'default'=>'', 'example'=>''],
            'receive_account' => ['type'=>'json', 'description'=>'收款账号', 'default'=>'', 'example'=>''],
