...
class sysaftersales_api_sendConfirm {
    ...
    public function getParams()
    {
        $return['params'] = array(
            ...
            'ziti_memo' => ['type'=>'string', 'valid'=>'', 'description'=>'自提备注'],
        );
    ...
    public function send($params)
    {
        ...
        $data['ziti_memo'] = $params['ziti_memo'];
        if($data['ziti_memo']){
            $result = kernel::single('sysaftersales_progress')->sendZiti($filter, 'seller', $data,$shopId);
        }else{
