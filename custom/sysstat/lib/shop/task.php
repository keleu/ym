...
class sysstat_shop_task 
{
    ...
    public function newTrade(array $params) 
    {
        ...
        $qb->select('count(*) as new_trade ,sum(payment) as new_fee,shop_id as shop_id,sum(payment_integral) as new_integral')
           ->from('systrade_trade')
    ...
    {
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('count(*) as ready_trade ,sum(payment) as ready_fee,shop_id as shop_id,sum(payment_integral) as ready_integral')
           ->from('systrade_trade')
    ...
    {
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('count(*) as alreadytrade ,sum(payment) as alreadyfee,shop_id as shop_id,sum(payment_integral) as alreadyintegral')
           ->from('systrade_trade')
           ->where('status<>"WAIT_BUYER_PAY"')
    ...
    {
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('count(*) as ready_send_trade ,shop_id as shop_id ,sum(payment) as ready_send_fee,sum(payment_integral) as ready_send_integral')
           ->from('systrade_trade')
    ...
    {
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('count(*) as already_send_trade ,shop_id as shop_id ,sum(payment) as already_send_fee,sum(payment_integral) as already_send_integral')
           ->from('systrade_trade')
    ...
    {
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('count(*) as complete_trade ,shop_id as shop_id ,sum(payment) as complete_fee,sum(payment_integral) as complete_integral')
           ->from('systrade_trade')
    ...
    {
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('count(*) as cancle_trade ,shop_id as shop_id ,sum(payment) as cancle_fee,sum(payment_integral) as cancle_integral')
           ->from('systrade_trade')
    ...
    public function hotGoods(array $params)
    {
        ...
        $qb = app::get('systrade')->database()->createQueryBuilder();
        $qb->select('sum(num) as itemnum ,shop_id as shop_id,bn as bn,title as title,item_id as item_id,pic_path as pic_path,sum(payment) as amountprice,sum(payment_integral) as amountintegral')
           ->from('systrade_order')
           ->where('status<>"WAIT_BUYER_PAY"')
           ->andWhere('pay_time>='.$qb->createPositionalParameter($params['time_start']))
           ->andWhere('pay_time<'.$qb->createPositionalParameter($params['time_end']))
