...
class sysstat_mdl_desktop_item_statics extends dbeav_model
{
    public function getStatGoodsList($cols='*',$filter,$offset=0, $limit=-1, $orderBy=null)
    {
        ...
        {
          $qb->select('I.shop_name as shop_name,sum(I.amountprice) as amountprice,sum(I.amountnum) as amountnum,I.title as title,I.pic_path as pic_path,I.item_id as item_id,I.cat_id as cat_id,I.cat_name as cat_name,sum(I.amountintegral) as amountintegral')
