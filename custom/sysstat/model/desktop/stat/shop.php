...
class sysstat_mdl_desktop_stat_shop extends dbeav_model
{
    public function getStoreList($cols='*',$filter,$offset=0, $limit=-1, $orderBy=null)
    {
        ...
        $qb->select('S.shopname as shopname,sum(S.shopaccountfee) as shopaccountfee,sum(S.shopaccountnum) as shopaccountnum,sum(S.shopaccountintegral) as shopaccountintegral')
