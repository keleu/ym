...
class sysstat_mdl_desktop_stat_userorder extends dbeav_model
{
    public function getUserList($cols='*',$filter,$offset=0, $limit=-1, $orderBy=null)
    {
        ...
        $qb->select('U.user_id as user_id,U.user_name as user_name,sum(U.userfee) as userfee,sum(U.userordernum) as userordernum,sum(U.userintegral) as userintegral')
