...
return  array(
    'columns'=>array(
        ...
        'ready_integral'=>array(
            'type' => 'number',
            'default' => 0,
            'comment' => app::get('sysstat')->_('待付款订单积分'),
        ),
        'alreadytrade'=>array(
            //'type'=>'varchar(50)',
            'type' => 'string',
        ...
        'alreadyfee'=>array(
            'type' => 'money',
            'default' => 0,
            'comment' => app::get('sysstat')->_('已付款订单额'),
            
        ),
        'alreadyintegral'=>array(
            'type' => 'number',
            'default' => 0,
            'comment' => app::get('sysstat')->_('已付款订单积分'),
        ...
        'ready_send_integral'=>array(
            'type' => 'number',
            'default' => 0,
            'comment' => app::get('sysstat')->_('待发货订单积分'),
        ...
        'already_send_integral'=>array(
            'type' => 'number',
            'default' => 0,
            'comment' => app::get('sysstat')->_('待收货订单积分'),
        ),
        'cancle_trade'=>array(
            //'type'=>'varchar(50)',
            'type' => 'number',
        ...
        'cancle_integral'=>array(
            'type' => 'number',
            'default' => 0,
            'comment' => app::get('sysstat')->_('已取消的订单积分'),
        ),
