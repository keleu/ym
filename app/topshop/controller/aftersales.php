...
class topshop_ctl_aftersales extends topshop_controller {
    ...
    public function detail()
    {
        ...
        $params['fields'] = 'aftersales_bn,shop_id,aftersales_type,sendback_data,description,sendconfirm_data,shop_explanation,admin_explanation,user_id,reason,evidence_pic,created_time,oid,tid,num,progress,status,sku,'.$tradeFields;
        try{
