...
return array(
    ...
    '积分设置' => array(
        'point.ratio' => array('type'=>SET_T_STR,'default'=>1,'desc'=>'积分换算比率:','vtype'=>'required&&positive','helpinfo'=>'<span class=\'notice-inline\'>默认1元 = 1积分【积分=金额*比率】</span>'),
    ...
    // 隐藏服务承诺
    // '服务承诺设置' => array(
    //     'site.tuihuo' => array('type'=>SET_T_STR,'default'=>'七天包退','desc'=>'退货内容:','vtype'=>'required','helpinfo'=>'<span class=\'notice-inline\'>默认七天包退</span>'),
    //     'site.huanhuo' => array('type'=>SET_T_STR,'default'=>'十五天包换','desc'=>'换货内容:','vtype'=>'required','helpinfo'=>'<span class=\'notice-inline\'>默认十五天包换</span>'),
    // ),
