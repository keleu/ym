...
return array(
    ...
    'item' => array(
        ...
        'group' => array(
            ...
            'printItem'      => ['label' => '商品打印',      'permission' => ['topshop.item.print','topshop.item.getPrint'] ],
    ...
    'trade' => array(
        ...
        'group' => array(
            ...
            'ziti' => [
                'label' => '自提点列表',
                'permission' => [
                    'topshop.ziti.listarea', 'topshop.ziti.editarea', 'topshop.ziti.deletearea', 'topshop.ziti.getarea', 'topshop.ziti.savearea',
                ],
            ],
            'ztset' => [
                'label' => '自提配置',
                'permission' => [
                    'topshop.ziti.setting', 'topshop.ziti.savesetting',
                ],
            ],
        ),
    ),
    ...
    'offline' => array(
        ...
        'group' => array(
            'mendian' => [
                'label' => '新增门店订单',
                'permission' => [
                    'topshop.offline.addtrade',//新增
                    'topshop.offline.getItems',//获取商品信息
                    'topshop.offline.checkVcode',//验证会员支付码
                    'topshop.offline.doPayment',//支付
                ],
            ],
        ),
    ),
    ...
    'shop' => array(
        ...
        'group' => array(
            ...
            'recommend' => [
                'label' => '橱窗商品',
                'permission' => [
                    'topshop.recommend.index','topshop.recommend.edit','topshop.recommend.save',
                ],
            ],
