     ...
     */
     'trade' => array(
        ...
        'menu' => array(
            ...
            //线下门店相关
            // array('label'=>'新增门店订单','display'=>true,'as'=>'topshop.offline.addtrade','action'=>'topshop_ctl_trade_offline@addtrade','url'=>'offline/addtrade.html','method'=>'get'),
            // array('label'=>'获取商品信息','display'=>false,'as'=>'topshop.offline.getItems','action'=>'topshop_ctl_trade_offline@getItems','url'=>'offline/getItems.html','method'=>'post'),
            // array('label'=>'验证会员支付码','display'=>false,'as'=>'topshop.offline.checkVcode','action'=>'topshop_ctl_trade_offline@checkVcode','url'=>'offline/checkVcode.html','method'=>'get'),
            // array('label'=>'验证会员支付码','display'=>false,'as'=>'topshop.offline.doPayment','action'=>'topshop_ctl_trade_offline@doPayment','url'=>'offline/doPayment.html','method'=>'post'),
            ...
            array('label'=>'自提点列表','display'=>true,'as'=>'topshop.ziti.listarea','action'=>'topshop_ctl_shop_ziti@index','url'=>'ziti/listarea.html','method'=>'get'),
            array('label'=>'编辑自提点','display'=>false,'as'=>'topshop.ziti.editarea','action'=>'topshop_ctl_shop_ziti@editarea','url'=>'ziti/editarea.html','method'=>'get'),
            array('label'=>'删除自提点','display'=>false,'as'=>'topshop.ziti.deletearea','action'=>'topshop_ctl_shop_ziti@deletearea','url'=>'ziti/deletearea.html','method'=>'post'),
            array('label'=>'根据地区id获取地区名称','display'=>false,'as'=>'topshop.ziti.getarea','action'=>'topshop_ctl_shop_ziti@getarea','url'=>'ziti/getarea.html','method'=>'post'),
            array('label'=>'保存自提点','display'=>false,'as'=>'topshop.ziti.savearea','action'=>'topshop_ctl_shop_ziti@savearea','url'=>'ziti/savearea.html','method'=>'post'),
            array('label'=>'自提配置','display'=>true,'as'=>'topshop.ziti.setting','action'=>'topshop_ctl_shop_ziti@setting','url'=>'ziti/setting.html','method'=>'get'),
            array('label'=>'保存自提配置','display'=>false,'as'=>'topshop.ziti.savesetting','action'=>'topshop_ctl_shop_ziti@savesetting','url'=>'ziti/savesetting.html','method'=>'post'),
        ),
     ),
 /*
    |--------------------------------------------------------------------------
    ...
    'offline' => array(
        'label' => '门店结算',
        'display' => true,
        'action' => 'topshop_ctl_trade_offline@addtrade',
        'icon' => 'glyphicon glyphicon-stats',
        'menu' => array(
            array('label'=>'新增门店订单','display'=>true,'as'=>'topshop.offline.addtrade','action'=>'topshop_ctl_trade_offline@addtrade','url'=>'offline/addtrade.html','method'=>'get'),
            array('label'=>'获取商品信息','display'=>false,'as'=>'topshop.offline.getItems','action'=>'topshop_ctl_trade_offline@getItems','url'=>'offline/getItems.html','method'=>'post'),
            array('label'=>'验证会员支付码','display'=>false,'as'=>'topshop.offline.checkVcode','action'=>'topshop_ctl_trade_offline@checkVcode','url'=>'offline/checkVcode.html','method'=>'get'),
            array('label'=>'支付','display'=>false,'as'=>'topshop.offline.doPayment','action'=>'topshop_ctl_trade_offline@doPayment','url'=>'offline/doPayment.html','method'=>'post'),
        ),
    ),
    ...
    'item' => array(
        ...
        'menu' => array(
            ...
            array('label'=>'商品打印','display'=>true,'as'=>'topshop.item.print','action'=>'topshop_ctl_item@itemPrint','url'=>'item/itemPrint.html','method'=>'get'),
            ...
            array('label'=>'商品搜索','display'=>false,'as'=>'topshop.item.search','action'=>'topshop_ctl_item@searchItem','url'=>'item/search.html','method'=>'get'),
            array('label'=>'货品搜索','display'=>false,'as'=>'topshop.item.searchSku','action'=>'topshop_ctl_item@searchSku','url'=>'item/searchSku.html','method'=>'post'),
            ...
            array('label'=>'打印商品','display'=>false,'as'=>'topshop.item.getPrint','action'=>'topshop_ctl_item@getPrint','url'=>'item/getPrint.html','method'=>'get'),
    ...
    'shop' => array(
        ...
        'menu' => array(
            ...
            //推荐商品
            array('label'=>'橱窗商品','display'=>true,'as'=>'topshop.recommend.index','action'=>'topshop_ctl_shop_recommend@edit','url'=>'recommend.html','method'=>'get'),
            array('label'=>'添加/编辑橱窗','display'=>false,'as'=>'topshop.recommend.edit','action'=>'topshop_ctl_shop_recommend@edit','url'=>'edit_recommend.html','method'=>'get'),
            array('label'=>'保存橱窗','display'=>false,'as'=>'topshop.recommend.save','action'=>'topshop_ctl_shop_recommend@save','url'=>'save_recommend.html','method'=>'post'),
