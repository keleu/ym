...
return array(
    ...
    'routes' => array(
        ...
        // 2016-5-9 by jianghui 消费者回寄退回自提点
        'aftersales.send.ziti' => ['uses' => 'sysaftersales_api_sendZiti@send', 'version'=>['v1']],
        ...
        //订单发货状态改变
        'trade.shop.update.delivery.status' => ['uses' => 'systrade_api_tradeDelivery@doDelivery', 'version' => ['v1'], 'oauth'=>true],

        //订单发货
        'logistics.shop.trade.delivery' => ['uses' => 'syslogistics_api_tradeDelivery@tradeDelivery', 'version' => ['v1'], 'oauth'=>true],
        ...
        //获取推荐商品
        'item.get.recommend' =>['uses' => 'sysitem_api_recommend@itemList','version'=>['v1']],
...
//      'user.check' => ['uses' => 'sysuser_api_user_account_check@check', 'version' => ['v1']],
        ...
        /*
         *=======================================
         *  代理商相关，by liuxin，2015-12-10
         *=======================================
         */
        //子代理商上向上级代理商购买积分
        'agent.point.trade' => ['uses' => 'sysagent_api_pointTrade@getPoint','version' => ['v1']],
        ...
        //2016-5-4 by jianghui 添加分页自提列表
        'logistics.ziti.search' => ['uses' => 'syslogistics_api_ziti_searchZiti@getList','version' => ['v1']],
